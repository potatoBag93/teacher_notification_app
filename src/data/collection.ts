...
export const savedNotices: SavedNotice[] = [
  {
    ...
    preview: '여름철 물놀이를 할 때는 반드시 어른과 함께 하고, 안전장비를 착용하세요.',
    tags: ['안전'],
    author: '김선생님',
    likeCount: 15,
  ...
  },
  {
    ...
    preview: '횡단보도를 건널 때는 좌우를 살피고, 신호를 잘 지켜주세요.',
    tags: ['안전'],
    author: '박선생님',
    likeCount: 23,
  ...
  },
  {
    ...
    preview: '매일 30분씩 책을 읽는 습관을 기르세요.',
    tags: ['학습'],
    author: '이선생님',
    likeCount: 18,
    createdAt: new Date('2025-07-15'),
  ...
  },
  {
    ...
    preview: '화재가 발생하면 당황하지 말고 선생님의 지시에 따라 질서있게 대피하세요.',
    tags: ['안전'],
    author: '김선생님',
    likeCount: 31,
  ...
  },
  {
    ...
    preview: '더운 여름에는 충분한 수분 섭취와 적절한 휴식이 중요합니다.',
    tags: ['건강'],
    author: '최선생님',
    likeCount: 27,
